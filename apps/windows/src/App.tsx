...
const menus: Array<{ name: string; items: MenuItem[] }> = [
  ...
  { name: "Device", items: ["Connect", "Disconnect", "Reconnect", "Reset Communication Session", "Rescan USB Devices", "Refresh Complete State", "Current Device Information", "Add Grid Block…", "Edit Signal Routing…", "Discard Unsaved Changes…", "Open Tuner", "Open Gig View", "Export Diagnostics…"] },
...
export function App() {
  ...
  }, [chooseScene, moveBlockSelection, navigateBank, openBlockEditor, pressFootswitch, removeSelectedBlock, selectedBlockId, showDeviceView, snapshot.blocks, tapTempo, toggleSelectedBypass]);
  ...
  const menuSelect = (item: string) => {
    ...
    else if (item === "Add Grid Block…") void openAddBlock();
