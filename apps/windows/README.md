...
- live scene selection, mode-aware A–H footswitches, guarded tempo/tap, block bypass and parameter editing, preset/setlist browsing, bank navigation, and keyboard shortcuts;
