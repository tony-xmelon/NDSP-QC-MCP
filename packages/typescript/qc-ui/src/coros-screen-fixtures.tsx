...
function DirectoryIcon({ kind, number }: { kind: "grid" | "download" | "cloud" | "cloud-upload" | "folder" | "new-folder" | "sort" | "filter" | "arrange" | "search" | "done" | "trash"; number?: number }) {
  ...
  if (kind === "filter") return <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 4h18l-7 8v6l-4 2v-8Z" fill="none" /></svg>;
...
function FavoriteIcon({ kind }: { kind: "heart" | "clock" | "binoculars" | "broken-heart" }) {
  if (kind === "clock") return <svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="9" fill="none" /><path d="M12 6v6l4 2" fill="none" /></svg>;
  if (kind === "binoculars") return <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M7 8 4 17a3 3 0 1 0 5.7 1l.8-4h3l.8 4A3 3 0 1 0 20 17l-3-9-3-2-2 3-2-3Z" fill="none" /><circle cx="6.5" cy="17" r="2.3" fill="none" /><circle cx="17.5" cy="17" r="2.3" fill="none" /></svg>;
  if (kind === "broken-heart") return <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 21 4.4 13.7C.5 9.8 3 4 7.4 4c2.1 0 3.4 1.2 4.6 2.7C13.2 5.2 14.5 4 16.6 4 21 4 23.5 9.8 19.6 13.7Z" /><path d="m13 6-3 5h3l-2 5" fill="none" stroke="#181c18" strokeWidth="2" /></svg>;
  return <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 21 4.4 13.7C.5 9.8 3 4 7.4 4c2.1 0 3.4 1.2 4.6 2.7C13.2 5.2 14.5 4 16.6 4 21 4 23.5 9.8 19.6 13.7Z" fill="none" /></svg>;
}
