...
export const demoSnapshot: PresetSnapshot = {
  ...
  blocks: [
    ...
    { id: "row-1-mod-a", name: "Vintage Chorus", kind: "mod", category: "Modulation", row: 0, column: 2, bypassed: true, glyph: "capture-grid" },
    { id: "row-1-mod-b", name: "Analog Flanger", kind: "mod", category: "Modulation", row: 0, column: 3, bypassed: true, glyph: "wave" },
    { id: "chorus", name: "Dimension", kind: "mod", category: "Modulation", row: 0, column: 4, bypassed: true, glyph: "wave" },
    ...
    { id: "pitch", name: "Dual Octaver", kind: "mod", category: "Pitch", row: 2, column: 1, bypassed: true, glyph: "level" },
    { id: "row-3-mod-a", name: "Vintage Tremolo", kind: "mod", category: "Modulation", row: 2, column: 2, color: "#ededed", glyph: "capture" },
    { id: "row-3-mod-b", name: "Dimension B", kind: "mod", category: "Modulation", row: 2, column: 3, bypassed: true, glyph: "wave" },
    ...
    { id: "row-3-out", name: "Looper X", kind: "cab", category: "Looper", row: 2, column: 7, glyph: "reverb" },
