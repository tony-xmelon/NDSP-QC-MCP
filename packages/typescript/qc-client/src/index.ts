...
export const demoSnapshot: PresetSnapshot = {
  ...
  blocks: [
    ...
    { id: "gate", name: "Gate", kind: "utility", row: 0, column: 0, bypassed: true },
    { id: "capture", name: "OD Capture", kind: "capture", row: 0, column: 1, bypassed: true },
    ...
    { id: "pitch", name: "Dual Octaver", kind: "mod", row: 2, column: 1 },
    { id: "row-3-mod-a", name: "Vintage Tremolo", kind: "mod", row: 2, column: 2, bypassed: true },
    ...
    { id: "row-3-cab", name: "2x12 Cream", kind: "cab", row: 2, column: 5 },
    { id: "reverb", name: "Mind Hall", kind: "reverb", row: 2, column: 6 },
    { id: "row-3-out", name: "Looper X", kind: "cab", row: 2, column: 7 },
