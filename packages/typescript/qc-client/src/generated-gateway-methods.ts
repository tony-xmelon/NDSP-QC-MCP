...
export const GATEWAY_API_VERSION = 17;
export const GATEWAY_CAPABILITIES = ["modelRepoParameterMetadata","nativeBroker","nativeStateEvents","nativeDeviceIdentity","nativeRemoteScreen","nativeSceneManagement","nativeParameterAssignments","nativeStompMetadata","nativePresetMidiOut","nativeExpressionBypass","nativeTunerSettings","nativeTunerWrites","nativeLaneControls","nativeGeneralSettings","nativeIoSettings","nativeGlobalEq","nativeModeCycle","nativeLooper","nativeLibraryManagement","nativeSplitMute","nativeTempoMetronome"] as const;
